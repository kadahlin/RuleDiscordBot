...
class MtgRule : Rule {
    ...
    private val _client: SkryfallCoroutineClient

    @Inject
    constructor() : super("MtgRule") {
        _client = SkryfallCoroutineClient.createClient(logCalls = true)
    }

    constructor(client: SkryfallCoroutineClient) : super("MtgRule") {
        _client = client
    }
