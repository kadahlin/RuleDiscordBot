...
*/
package com.kyledahlin.myrulebot.leaguerule
...
internal class LeagueRule @Inject constructor(
    ...
    private fun MessageCreated.containsLeagueRankRule() = com.kyledahlin.myrulebot.leaguerule.leagueRegex.containsMatchIn(content)
