...
*/
package com.kyledahlin.myrulebot.bot.samplejava
...
class SampleJavaRuleTest {
    ...
    private lateinit var _rule: com.kyledahlin.myrulebot.bot.samplejava.SampleJavaRule
    ...
    fun setup() {
        ...
        _rule = com.kyledahlin.myrulebot.bot.samplejava.SampleJavaRule(_mockLocalStorage, _mockEventStorage)
    }

    @Test
    fun `the java rule should respond to its valid event`() = runBlocking {
        val valid = com.kyledahlin.myrulebot.bot.samplejava.SampleJavaRule.getValidTestEvent()
    ...
    fun `the java rule should not respond to its invalid event`() = runBlocking {
        val invalid = com.kyledahlin.myrulebot.bot.samplejava.SampleJavaRule.getInvalidTestEvent()
